    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, 'canceled'), (1, 'scheduled'), (2, 'waiting'), (3, 'passed'), (4, 'failed')], default=1, verbose_name='interview state')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='interview_app.question', verbose_name='interview')),
            ],
        ),
    ]
